...
package testnewtemplatesamplesdk

import (
	"bytes"
	"context"
	"fmt"
	"github.com/speakeasy-sdks-staging/test-new-template-sample-sdk/pkg/models/operations"
	"github.com/speakeasy-sdks-staging/test-new-template-sample-sdk/pkg/models/sdkerrors"
	"github.com/speakeasy-sdks-staging/test-new-template-sample-sdk/pkg/models/shared"
	"github.com/speakeasy-sdks-staging/test-new-template-sample-sdk/pkg/utils"
	"io"
	"net/http"
	"strings"
)
